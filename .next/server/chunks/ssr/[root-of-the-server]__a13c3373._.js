...
"[project]/src/utils/axiosIntance.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
axiosInstance.interceptors.response.use((response)=>response, (error)=>{
    if (error.response && error.response.status === 403) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])().push("/login");
    }
    return Promise.reject(error);
});
...
"[project]/src/components/Login/Login.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosIntance$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/axiosIntance.tsx [app-ssr] (ecmascript)");
...
function Login() {
    ...
    const [hasCharacter, setHasCharacter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    async function checkCharacterAndAuth() {
        try {
            ...
            const characterResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosIntance$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/characters/my-character/${userId}`);
    ...
    const handleLoginSubmit = async (event)=>{
        ...
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosIntance$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/users/login", {
                email,
                password
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a13c3373._.js.map