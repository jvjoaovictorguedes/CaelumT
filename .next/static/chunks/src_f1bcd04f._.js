...
function CharacterCreation() {
    ...
    const handlerSubmit = async (e)=>{
        ...
        setErrorMessage("");
        setIsLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$create$2f$action$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCharacter"])({
            name,
            gender,
            selectedRace
        });
    ...
    async function CreateCharacter(characterDetails) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosIntance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/characters", characterDetails);
            console.log("Personagem criado com sucesso:", response.data);
...
_s(CharacterCreation, "RZN/B7bAZtYYv3NplrSwJqbyfn8=", false, function() {
    return [
...
//# sourceMappingURL=src_f1bcd04f._.js.map